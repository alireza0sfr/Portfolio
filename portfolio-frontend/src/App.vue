          ...
          <div class="collapse navbar-collapse" id="navmenu">
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item pb-1 pt-1">
                <a @click="showModal()" style="cursor: pointer" class="navbar-brand nav-link d-none d-sm-inline"
                  >Hire Me</a
                >
                ...
                <a
                  ...
                  class="navbar-brand nav-link d-sm-none"
                  >Hire Me</a
                >
              </li>
              <li class="nav-item pb-1 pt-1">
                <a href="../assets/alireza-safari-resume.pdf" target="_blank" class="navbar-brand nav-link"
                  >Download CV</a
                >
              </li>
            </ul>
